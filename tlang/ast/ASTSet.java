...
public class ASTSet extends ASTNode {

	ASTNode left, right;
	
	public ASTSet(ParserRuleContext ctx, ASTNode left, ASTNode right) {
		super(ctx);
		this.left = left;
		this.right = right;
	}
	...
	public EvalResult evaluate(Frame frame) throws TLangException {
		...
		TLangObject operatorMethod = leftValue.$get(TLangConstants.$set);
	...
	public TLangObject expression() throws TLangException {
		...
		obj.$set(new TLangText("operator"), TLangConstants.$set);
		return obj;
	}
